...
var yages = {
    ...
    "巡天智者鸦": {
        ...
        emoji: "🦅",
        image: "yages/巡天智者鸦.jpg".replace(".jpg", ".webp"),
    ...
    "待机隐士鸦": {
        ...
        dimension: "电量高 + 情绪低",
        emoji: "🦅",
        image: "yages/待机隐士鸦.jpg".replace(".jpg", ".webp"),
    ...
    "行动爆发鸦": {
        ...
        dimension: "电量高 + 行动高",
        emoji: "🔥",
        image: "yages/行动爆发鸦.jpg".replace(".jpg", ".webp"),
    ...
    "舒适咸鱼鸦": {
        ...
        emoji: "🐟",
        image: "yages/舒适咸鱼鸦.jpg".replace(".jpg", ".webp"),
    ...
    "社交探索鸦": {
        ...
        emoji: "🦜",
        image: "yages/社交探索鸦.jpg".replace(".jpg", ".webp"),
    ...
    "电量中转鸦": {
        ...
        emoji: "🚉",
        image: "yages/电量中转鸦.jpg".replace(".jpg", ".webp"),
    ...
    "迷雾探险鸦": {
        ...
        emoji: "🌫️",
        image: "yages/迷雾探险鸦.jpg".replace(".jpg", ".webp"),
    ...
    "伪装讨喜鸦": {
        ...
        emoji: "🎭",
        image: "yages/伪装讨喜鸦.jpg".replace(".jpg", ".webp"),
    ...
    "疗愈独处鸦": {
        ...
        emoji: "🌙",
        image: "yages/疗愈独处鸦.jpg".replace(".jpg", ".webp"),
    ...
    "电量透支鸦": {
        ...
        emoji: "⚡",
        image: "yages/电量透支鸦.jpg".replace(".jpg", ".webp"),
    ...
    "燃尽冲刺鸦": {
        ...
        emoji: "💨",
        image: "yages/燃尽冲刺鸦.jpg".replace(".jpg", ".webp"),
    ...
    "破晓微光鸦": {
        ...
        emoji: "🌅",
        image: "yages/破晓微光鸦.jpg".replace(".jpg", ".webp"),
